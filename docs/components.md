...
> 共 25+ 组件，按用途分组。每个组件的 props 详见 [api.md](./api.md)。
...
| 组件 | 说明 |
|---|---|
| [`Input`](./api.md#input) | 单行文本框，支持前/后置图标 |
...
| 组件 | 说明 |
|---|---|
| [`Modal`](./api.md#modal) | 模态对话框 |
| [`Drawer`](./api.md#drawer) | 抽屉面板 |
...
| 组件 | 说明 |
|---|---|
| [`Table`](./api.md#table) | 数据表格，支持自定义列渲染 |
| [`List`](./api.md#list) | 列表，头像 + 标题 + 描述 + 操作 |
| [`Tag`](./api.md#tag) | 标签 |
| [`Badge`](./api.md#badge) | 角标 / 红点 |
| [`Avatar`](./api.md#avatar) | 头像，支持状态点 |
| [`Calendar`](./api.md#calendar) | 日历 |
| [`Empty`](./api.md#empty) | 空状态 |
